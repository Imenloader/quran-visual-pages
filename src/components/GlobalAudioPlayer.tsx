...
const GlobalAudioPlayer = () => {
  ...
  return (
    <div className="fixed bottom-28 left-0 right-0 z-[110] px-4 pointer-events-none flex justify-center">
      {isFullScreen ? (
        <div
          className="fixed inset-0 bg-background/98 backdrop-blur-xl z-[200] pointer-events-auto flex flex-col p-8 transition-all duration-500 opacity-100 translate-y-0"
        >
        ...
        <div
          className="bg-primary/95 md:bg-primary/40 backdrop-blur-md md:backdrop-blur-2xl border border-primary/10 rounded-[3rem] shadow-[0_12px_40px_rgba(0,0,0,0.4)] p-2.5 flex items-center gap-4 min-w-[280px] max-w-[420px] pointer-events-auto transform-gpu transition-all duration-300 opacity-100 translate-y-0"
        >
          <Tooltip>
            <TooltipTrigger asChild>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  size="icon"
                  onClick={togglePlay}
                  className="size-10 rounded-full bg-gold text-primary hover:scale-105 active:scale-95 shadow-lg shadow-gold/20 transition-all"
                >
            ...
            <div className="flex flex-col gap-1">
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className="p-1 text-white/40 hover:text-white hover:bg-white/5 transition-all rounded-full active:scale-90"
                  >
                    <ChevronDown size={14} />
                  </button>
                </TooltipTrigger>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    onClick={stopPlayer}
                    className="p-1 text-red-400/40 hover:text-red-400 hover:bg-red-400/10 transition-all rounded-full active:scale-90"
                  >
                    <X size={14} />
                  </button>
                </TooltipTrigger>
