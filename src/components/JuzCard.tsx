    ...
    >
      ...
      >
        ...
        <div className="absolute top-6 left-6 flex flex-col gap-3 z-10">
          <button
            ...
            className={`w-10 h-10 rounded-2xl flex items-center justify-center transition-all backdrop-blur-sm ${
              isFav ? "bg-red-500/10 text-red-500" : "bg-muted/50 text-muted-foreground hover:bg-red-500/5 hover:text-red-400"
            }`}
          >
        ...
        <div className="text-center space-y-2">
          ...
          <div className="pt-4">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-muted/40 text-[11px] text-muted-foreground font-naskh">
        ...
        <div className="mt-8 pt-6 border-t border-border/40 flex items-center justify-between">
          ...
          <div className="text-[10px] text-muted-foreground/60 font-serif uppercase tracking-widest">
            Juz {juz.number}
          </div>
        </div>
