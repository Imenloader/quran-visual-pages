...
export const surahByName = new Map<string, SurahInfo>(surahIndex.map(s => [s.name, s]));
export const surahByNumber = new Map<number, SurahInfo>(surahIndex.map(s => [s.number, s]));
export const surahByNumberString = new Map<string, SurahInfo>(surahIndex.map(s => [s.number.toString(), s]));
