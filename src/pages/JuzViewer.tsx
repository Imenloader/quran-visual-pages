...
import { juzData, getQuranPageFallbackImageUrl, toArabicNumber, surahIndex, surahByName, surahByNumber, surahByNumberString } from "@/data/quranData";
      ...
      if (pages.length > 0 && currentPage === 0) {
        ...
        if (location.hash) {
          if (location.hash.startsWith('#verse-')) {
            ...
            const surah = surahByNumberString.get(sNum);
