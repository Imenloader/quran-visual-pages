          ...
          <div className="flex-1">
            {num > 1 && (
              ...
              >
                ...
                <span className="opacity-60 group-hover:opacity-100 italic">الجزء السابق</span>
              </Link>
            )}
          </div>
          ...
          <div className="flex-1 flex justify-end">
            {num < 30 && (
              <Link
                ...
                className="group flex items-center gap-3 text-sm font-serif font-medium text-muted-foreground hover:text-primary transition-all"
              >
                <span className="opacity-60 group-hover:opacity-100 italic">الجزء التالي</span>
                <div className="w-8 h-8 rounded-full bg-muted/50 flex items-center justify-center group-hover:bg-primary/5 transition-colors">
      ...
      {!isFullscreen && (
        <div className="text-center pb-12">
          ...
          >
            ...
            <span className="italic opacity-60 group-hover:opacity-100">العودة للبداية</span>
          </button>
        </div>
      )}
