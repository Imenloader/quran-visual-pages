...
import { juzData, toArabicNumber, surahIndex, surahByName, surahByNumber, surahByNumberString, surahData, SurahInfo } from "@/data/quranData";
...
function Index() {
  ...
  useEffect(() => {
    const searchQuran = async () => {
      ...
      const matchedSurahs = surahData.filter(s => {
