          ...
          >
            <div className="bento-card !p-8 text-center space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Button variant="outline" className="h-20 rounded-2xl flex flex-col gap-1 active:scale-95" onClick={() => handleStart("all")}>
                  <Star className="w-5 h-5 text-amber-500" />
                  <span>{isAr ? "كل الفئات" : "All Categories"}</span>
                </Button>
                <Button variant="outline" className="h-20 rounded-2xl flex flex-col gap-1 active:scale-95" onClick={() => handleStart("quran")}>
                  <Book className="w-5 h-5 text-emerald-500" />
                  <span>{isAr ? "القرآن الكريم" : "Holy Quran"}</span>
                </Button>
                <Button variant="outline" className="h-20 rounded-2xl flex flex-col gap-1 active:scale-95" onClick={() => handleStart("sahaba")}>
                  <Users className="w-5 h-5 text-blue-500" />
                  <span>{isAr ? "الصحابة" : "Sahaba"}</span>
                </Button>
                <Button variant="outline" className="h-20 rounded-2xl flex flex-col gap-1 active:scale-95" onClick={() => handleStart("fiqh")}>
            ...
            <div className="bento-card !p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 gap-3">
                {(isAr ? currentQuestion.optionsAr : currentQuestion.optionsEn).map((option, idx) => {
                  ...
                  if (isAnswered) {
                    ...
                    className += "hover:border-primary hover:bg-primary/5 active:scale-95 ";
                  }
              ...
              {isAnswered && (
                ...
                >
                  ...
                  <Button className="w-full h-12 rounded-xl active:scale-95" onClick={handleNext}>
        ...
        {currentStep === "result" && (
          ...
          >
            <div className="bento-card !p-12 text-center space-y-8">
              ...
              <Button className="w-full h-14 rounded-2xl text-lg gap-2 active:scale-95" onClick={resetQuiz}>
