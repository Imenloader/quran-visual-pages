...
const steps = [
  ...
  },
  {
    ...
    desc: "اضغط على زر التحميل (⬇) بجانب أي جزء لتحميله، أو اضغط مطولاً على بطاقة الجزء. يمكنك أيضاً تحميل المصحف كاملاً من الزر المخصص في مركز الأدوات.",
  },
  {
  ...
  },
  {
    icon: <Heart size={22} />,
    title: "المفضلة",
    desc: "اضغط على القلب (❤️) بجانب أي سورة لإضافتها للمفضلة، أو النجمة (⭐) بجانب أي قارئ لتفضيله. يمكنك تصفح كل المفضلات من صفحة المفضلة مع تبويبات منفصلة.",
  },
  {
    icon: <ListMusic size={22} />,
    title: "قوائم التشغيل",
    desc: "من تبويب \"قوائم التشغيل\" في صفحة التلاوات: استخدم القوائم الجاهزة أو أنشئ قوائم مخصصة. اضغط (+) بجانب أي سورة لإضافتها لقائمة.",
  },
  {
    icon: <Shield size={22} />,
    title: "الأذكار",
  ...
  },
  {
    ...
    desc: "من الإعدادات أو زر القمر أثناء القراءة: فعّل الوضع الداكن. استخدم شريط تمرير \"شدة الإعتام\" لضبط سطوع صفحات المصحف حسب راحة عينيك.",
  },
  {
    icon: <Bell size={22} />,
    title: "التنبيهات",
  ...
  },
  {
    ...
    title: "مركز الأدوات (Hub)",
    desc: "يحتوي على أدوات إيمانية متكاملة: اتجاه القبلة، المسبحة الإلكترونية، حاسبة الزكاة، أسماء الله الحسنى، منبه الختمة، متتبع الصلوات، ومكتشف المساجد والمطاعم الحلال. يمكنك الوصول إليه من القائمة السفلية.",
  },
  {
    icon: <Settings size={22} />,
    title: "التجويد الملون",
    desc: "فعّل وضع التجويد الملون من الإعدادات لتلوين أحرف المصحف بناءً على أحكام التجويد، مما يسهل عليك القراءة الصحيحة والتدبر في معاني الآيات.",
  },
  {
    icon: <Smartphone size={22} />,
    title: "تثبيت التطبيق",
  ...
  },
  {
    ...
    desc: "إذا كنت جديداً أو تريد تذكراً لميزات التطبيق، يمكنك تفعيل الجولة التعريفية من الإعدادات في صفحة الملف الشخصي لتأخذك في جولة تفاعلية.",
  },
  {
    icon: <Heart size={22} />,
    title: "موسوعة الصحابة",
    desc: "استكشف سير الصحابة الكرام، المهاجرين، والأنصار، والعشرة المبشرين بالجنة من خلال الموسوعة الشاملة في مركز الأدوات.",
  },
];
